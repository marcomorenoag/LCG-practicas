...
// Keyframes
float posX =PosIni.x, posY = PosIni.y, posZ = PosIni.z, rotRodIzq = 0, rotBrIzq, rotBrDer, rotRodDer;
...
void interpolation(void)
{
	...
	KeyFrame[playIndex].rotIncBrIzq = (KeyFrame[playIndex + 1].rotBrIzq - KeyFrame[playIndex].rotBrIzq) / i_max_steps;
	KeyFrame[playIndex].rotIncRodDer = (KeyFrame[playIndex + 1].rotRodDer - KeyFrame[playIndex].rotRodDer) / i_max_steps;
	KeyFrame[playIndex].rotIncBrDer = (KeyFrame[playIndex + 1].rotBrDer - KeyFrame[playIndex].rotBrDer) / i_max_steps;
...
int main()
{
	...
	for(int i=0; i<MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].incY = 0;
		KeyFrame[i].incZ = 0;
		KeyFrame[i].rotRodIzq = 0;		// Pierna Izq
		KeyFrame[i].rotIncRodIzq = 0;
		KeyFrame[i].rotBrIzq = 0;		// Brazo Izq
		KeyFrame[i].rotIncBrIzq = 0;
		KeyFrame[i].rotBrDer = 0;		// Brazo Der
		KeyFrame[i].rotIncBrDer = 0;
		KeyFrame[i].rotRodDer = 0;		// Pierna Der
